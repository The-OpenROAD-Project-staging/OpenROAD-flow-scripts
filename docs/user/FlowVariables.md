...
| <a name="SYNTH_SORT_BEFORE_ABC"></a>SYNTH_SORT_BEFORE_ABC| Sort design objects before ABC execution to produce deterministic synthesis results. Workaround for Yosys nondeterminism where abc_new visits modules in dict insertion order which can vary between runs.| 1|
...
- [SYNTH_SORT_BEFORE_ABC](#SYNTH_SORT_BEFORE_ABC)
