...
if { $place_ios } {
  ...
  # No periodic assignment here, to price what reordering the pins is worth
  # against holding them a slot apart alone.
  lappend global_placement_args -place_ios_legalize_every 0
}
